...
import com.cw.eventlog.App;
import com.cw.eventlog.base.Constants;
...
public class CalendarEvent {
    ...
    private static final String ACCOUNT_NAME = Constants.ACCOUNT_NAME;
    ...
    public static void insertEvent(EventModel model) {
        ...
        Uri newEvent = App.sContext.getContentResolver().insert(eventsUri, event);
